                ...
                <div class="row row-mar ">
                    <div class="col-12 col-md-9">
                        <div class="h-100 AMB-background AMB-reward AMB-content">
                            <img style="width: 100%;"  src=" {{ url('/images/banner-stockchina.png') }}">
                            <h1 class="AMB-contact-title-gradient">หวยหุ้นจีน</h1>
                            <h2 class="AMB-contact-title">หวยหุ้นจีน กติกาการเเทง ZONELOTTO</h2>
                            <ul>
                            ...
                            <h2 class="AMB-contact-title">วิธีการดูผลหวยหุ้นจีน</h2>
                            <ul>

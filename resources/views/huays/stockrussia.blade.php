                ...
                <div class="row row-mar ">
                    <div class="col-12 col-md-9">
                        <div class="h-100 AMB-background AMB-reward AMB-content">
                            <img style="width: 100%;" src=" {{ url('/images/banner-stockrussia.png') }}">
                            <h1 class="AMB-contact-title-gradient">หวยหุ้นรัสเซีย</h1>
                            <h2 class="AMB-contact-title">หวยหุ้นรัสเซีย กติกาการเเทง ZONELOTTO</h2>
                            <ul>
                            ...
                            <h2 class="AMB-contact-title">วิธีการดูผลหวยหุ้นรัสเซีย</h2>
                            <ul>
